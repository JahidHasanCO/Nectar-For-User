...
public class UploadAvaterActivity extends AppCompatActivity {
    private String uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skipTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UploadAvaterActivity.this,MainActivity.class));
            }
        });
    }
                            ...
                            ref.child(uid).updateChildren(hashMap)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Intent intent = new Intent(UploadAvaterActivity.this,MainActivity.class);
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            //failed updating
                                            progressDialog.dismiss();
                                            Toast.makeText(UploadAvaterActivity.this, ""+e.getMessage(),Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    }
